...
const DoctorCard = ({ doctor }) => {
  ...
  return (
    <div className="p-3 lg:p-5">
      ...
      <h2
        className="text-[18px] leading-[30px] lg:text-[25px]
      ...
      <div className="mt-2 lg:mt-4 flex items-center justify-between">
        ...
        <div className="flex items-center gap-[6px]">
          ...
          >
            <img src={startImg} alt="startIcon" />
            {avgRating}
          </span>
          <span
            className="text-[14px] leading-6 lg:text-[16px] lg:leading-7 font-[400]
          text-textColor"
          >
            ({totalRating})
          </span>
      ...
      <div className="mt-[18px] lg:mt-5 flex items-center justify-between">
        <div>
          <h3 className="text-[18px] leading-7 lg:text-[18px] lg:leading[30px] font-semibold text-headingColor">
            +<span className="text-red-400">{totalPatients}</span>patients
          </h3>
          <p className="tex-[16px] leading-6 font-[400] text-textColor">
            At {hospital}
          </p>
        </div>
        <Link
