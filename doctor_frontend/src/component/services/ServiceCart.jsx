...
const ServiceCart = ({ item, index }) => {
  ...
  return (
    <div className="py-[30px] px-3 lg:px-5">
      ...
      <p className="text-[16px] leading-7 font-[400] text-text-textColor mt-4">
        {desc}
      </p>
      <div className="flex items-center justify-between mt-[30px]">
        <Link
          ...
          className="w-[45px] h-[44px] rounded-full border border-solid 
                  border-[#181A1E] mt-[30px]  flex items-center justify-center group
